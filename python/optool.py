...
def get_icb_spending_data(chemical_code):
    ...
    #creating a new list that filters data for which ICBs have prescribed the chemical most frequently, per date
    new_list = filter_spending_data(results)
...
def filter_spending_data(data):
    ...
    for date in unique_dates:
        ...
        filtered_list = list(filter(lambda x: x["date"] == date, data))
